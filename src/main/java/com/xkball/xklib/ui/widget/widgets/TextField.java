...
public class TextField extends ScrollableFlexLayout {
    ...
    protected void updateInnerParam() {
        ...
        this.inner.actualWidth = expectWidth;
        this.inner.actualHeight = expectHeight;
    ...
    public class TextFieldInner extends AbstractWidget {
        ...
        public void resize() {
            ...
            TextField.this.inner.actualWidth = newExpectWidth;
            TextField.this.inner.actualHeight = newExpectHeight;
