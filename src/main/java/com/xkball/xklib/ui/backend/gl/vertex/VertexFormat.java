...
public class VertexFormat {
    ...
    private VBOBuffer immediateDrawVertexBuffer;
    private IBOBuffer immediateDrawIndexBuffer;
    private VAOBuffer formatVertexArrayBuffer;
    ...
    public VAOBuffer getFormatVertexArrayBuffer() {
        if(formatVertexArrayBuffer == null){
            formatVertexArrayBuffer = new VAOBuffer();
            
        }
        formatVertexArrayBuffer.setupVertexAttributes(this);
        return formatVertexArrayBuffer;
    }
    ...
    public void uploadImmediateVertexBuffer(ByteBuffer buffer) {
        if (immediateDrawVertexBuffer == null) {
            immediateDrawVertexBuffer = new VBOBuffer();
        }
        immediateDrawVertexBuffer.upload(buffer);
    }

    public void uploadImmediateIndexBuffer(ByteBuffer buffer) {
        if (immediateDrawIndexBuffer == null) {
            immediateDrawIndexBuffer = new IBOBuffer();
        }
        immediateDrawIndexBuffer.upload(buffer);
    }
    
    public VBOBuffer getImmediateDrawVertexBuffer() {
        return immediateDrawVertexBuffer;
    }
    
    public IBOBuffer getImmediateDrawIndexBuffer() {
