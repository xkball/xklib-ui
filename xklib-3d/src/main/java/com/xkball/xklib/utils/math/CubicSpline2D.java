...
public class CubicSpline2D {
    ...
    public static CubicSpline2D BEZIER = new CubicSpline2D(3,
            new Matrix4d(
               1, 0, 0,0,
              -3, 3, 0,0,
               3,-6, 3,0,
    ...
    public static CubicSpline2D HERMITE = new CubicSpline2D(2,
            new Matrix4d(
                     1, 0,  0, 0,
                     0, 1,  0, 0,
                    -3,-2,  3,-1,
    ...
    public static CubicSpline2D B = new CubicSpline2D(1,
            new Matrix4d(
                    1/6d, 4/6d, 1/6d,    0,
                    -0.5,    0,  0.5,    0,
                     0.5,   -1,  0.5,    0,
    ...
    public CubicSpline2D(int step, Matrix4d param) {
        this.step = step;
        this.param = param;
