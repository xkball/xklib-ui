...
public class FlexParam {
    ...
    /*
    在主轴上如果子元素使用的size使用Weight, 则此值为一份权重的大小, 如果本身填入的就是Weight, 则等同于100%.
     */
    ...
    public static class Builder {
        ...
        public FlexLayout newFlexLayout(){
            return new FlexLayout(this.build());
        }
        
        public ScrollableFlexLayout newScrollable(){
            return new ScrollableFlexLayout(this.build());
        }
