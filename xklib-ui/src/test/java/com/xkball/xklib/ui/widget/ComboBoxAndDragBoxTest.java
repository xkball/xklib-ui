...
public class ComboBoxAndDragBoxTest {
    ...
    public static void main(String[] ignored) throws Exception {
        try (var frame = new WidgetTestFrame(() -> {
            ...
            var title = new Label("ComboBox 和 DragBox 测试", 0xFFE2E8F0);
    ...
    private static ContainerWidget createComboBoxSection() {
        ...
        var sectionTitle = new Label("ComboBox 示例",  0xFF94A3B8);
        var titleStyle = new TaffyStyle();
        ...
        var selectedLabel1 = new Label("选择: " + comboBox1.getSelected(),  0xFFE2E8F0);
        ...
        var selectedLabel2 = new Label("选择: 无",  0xFFE2E8F0);
    ...
    private static ContainerWidget createDragBoxSection() {
        ...
        var sectionTitle = new Label("DragBox 示例", 0xFF94A3B8);
        var titleStyle = new TaffyStyle();
        titleStyle.size = new TaffySize<>(TaffyDimension.percent(1f), TaffyDimension.length(24));
        titleStyle.flexShrink = 0;
        section.addChild(sectionTitle, titleStyle);
        ...
        var valueLabel1 = new Label(String.format("值: %.2f (范围: 0 - 100)", drag1.getValue()), 0xFFE2E8F0);
        ...
        var valueLabel2 = new Label(String.format("值: %.3f (范围: -1.0 - 1.0)", drag2.getValue()), 0xFFE2E8F0);
        ...
        var valueLabel3 = new Label(String.format("整数值: %d", (int) drag3.getValue()), 0xFFE2E8F0);
